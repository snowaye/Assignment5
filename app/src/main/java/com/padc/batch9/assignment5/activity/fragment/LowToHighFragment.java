...
public class LowToHighFragment extends Fragment implements HouseItemDelegate, View.OnClickListener, TextWatcher {

    public LowToHighFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_low_to_high_price, container,false);
